...
<body>
	...
	<div class="container">
		...
		<h1 class="bg-danger text-center">회 원 가 입</h1>
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userId" name="userId" placeholder="중복확인하세요" required>
		       <div id="id_check"></div>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" class="btn btn-danger"  >가 &nbsp;입</button>
