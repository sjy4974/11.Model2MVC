...
<body>
	...
	<div class="container">
		...
		<div class="page-header text-center">
	       ...
	       <h5 class="text-muted">상품 정보 수정 페이지 입니다.</h5>
	    </div>
		...
		<input type="hidden" name="prodNo" value="${product.prodNo}"/>
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="prodName" name="prodName" value="${product.prodName}" placeholder="중복확인하세요" >
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="price" name="price" value="${product.price}" placeholder="가 격">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="regDate" name="regDate"  value="${product.regDate}" placeholder="등록일자" readonly>
		      <span id="helpBlock" class="help-block" >
		      	<strong class="text-danger">수정불가</strong>
		      </span>
		    </div>
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" class="btn btn-danger"  >수 &nbsp;정</button>
